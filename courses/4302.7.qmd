...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:75%" code-line-numbers="3"} 
#include "nthread-impl.h"
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:75%" code-line-numbers="5-12"} 
#include "nthread-impl.h"
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:75%" code-line-numbers="9"} 
#include "nthread-impl.h"
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:75%" code-line-numbers="14-23"} 
#include "nthread-impl.h"
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:75%" code-line-numbers="25-33"} 
#include "nthread-impl.h"
...
::: {.columns}
::: {.column width="55%"}
```{.c style="font-size:70%" code-line-numbers="5-8"} 
static void nth_pri1Schedule(void) {
  CHECK_CRITICAL("nth_fcfsSchedule")
...
::: {.columns}
::: {.column width="55%"}
```{.c style="font-size:70%" code-line-numbers="10"} 
static void nth_pri1Schedule(void) {
  CHECK_CRITICAL("nth_fcfsSchedule")
...
::: {.columns}
::: {.column width="55%"}
```{.c style="font-size:70%" code-line-numbers="12-16"} 
static void nth_pri1Schedule(void) {
  CHECK_CRITICAL("nth_fcfsSchedule")
...
::: {.columns}
::: {.column width="55%"}
```{.c style="font-size:70%" code-line-numbers="17-20"} 
static void nth_pri1Schedule(void) {
  CHECK_CRITICAL("nth_fcfsSchedule")
...
::: {.columns}
::: {.column width="55%"}
```{.c style="font-size:70%" code-line-numbers="21-27"} 
static void nth_pri1Schedule(void) {
  CHECK_CRITICAL("nth_fcfsSchedule")
...
::: {.columns}
::: {.column width="55%"}
```{.c style="font-size:70%" code-line-numbers="22-23"} 
static void nth_pri1Schedule(void) {
  CHECK_CRITICAL("nth_fcfsSchedule")
...
::: {.columns}
::: {.column width="55%"}
```{.c style="font-size:70%" code-line-numbers="29"} 
static void nth_pri1Schedule(void) {
  CHECK_CRITICAL("nth_fcfsSchedule")
...
::: {.columns}
::: {.column width="55%"}
```{.c style="font-size:70%" code-line-numbers="31"} 
static void nth_pri1Schedule(void) {
  CHECK_CRITICAL("nth_fcfsSchedule")
...
::: {.columns}
::: {.column width="55%"}
```{.c style="font-size:70%" code-line-numbers="33"} 
static void nth_pri1Schedule(void) {
  CHECK_CRITICAL("nth_fcfsSchedule")
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:65%" code-line-numbers="8-11"} 
static void nth_pri1Stop(void) {
  CHECK_CRITICAL("nth_fcfsStop")
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:65%" code-line-numbers="13-35"} 
static void nth_pri1Stop(void) {
  CHECK_CRITICAL("nth_fcfsStop")
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:65%" code-line-numbers="22-23"} 
static void nth_pri1Stop(void) {
  CHECK_CRITICAL("nth_fcfsStop")
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:65%" code-line-numbers="24"} 
static void nth_pri1Stop(void) {
  CHECK_CRITICAL("nth_fcfsStop")
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:65%" code-line-numbers="25-32"} 
static void nth_pri1Stop(void) {
  CHECK_CRITICAL("nth_fcfsStop")
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:65%" code-line-numbers="1-6"} 
static void nth_pri1Stop(void) {
  CHECK_CRITICAL("nth_fcfsStop")
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:65%" code-line-numbers="4-5"} 
static void nth_pri1Stop(void) {
  CHECK_CRITICAL("nth_fcfsStop")
...
::: {.columns}
::: {.column width=""}
```{.c style="font-size:65%" code-line-numbers="37-39"} 
static void nth_pri1Stop(void) {
  CHECK_CRITICAL("nth_fcfsStop")
